...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        if self.order_total < settings.FREE_SHIPPING_GOAL:
            self.shipping_cost = self.order_total * settings.STANDARD_SHIPPING_CHARGE / 100
        else:
...
class OrderLineItem(models.Model):
    ...
    item_size = models.CharField(max_length=3, null=True, blank=True)
